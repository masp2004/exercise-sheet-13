...
public final class DataGenerator {
	...
	public static void fillRecordWithTestData(final StudentRecord record) {
		...
		record.addStudent(new Student("Lorelei", LocalDate.parse("15-12-1993", df), Student.Sex.FEMALE,
				"lorelei@uni-stuttgart.de"));

		record.addStudent(
				new Student("Tina", LocalDate.parse("11-11-2000", df), Student.Sex.FEMALE, "tina@uni-stuttgart.de"));

		record.addStudent(new Student("Vincent", LocalDate.parse("31-10-1995", df), Student.Sex.MALE,
				"vincent@uni-stuttgart.de"));
		...
		record.addStudent(new Student("Tamara", LocalDate.parse("17-09-1991", df), Student.Sex.FEMALE,
				"tamara@uni-stuttgart.de"));
		...
		record.addStudent(new Student("Lara Croft", LocalDate.parse("15-11-1998", df), Student.Sex.FEMALE,
				"L.C.@uni-stuttgart.de"));

		record.addStudent(new Student("Scooby-Doo", LocalDate.parse("12-02-2008", df), Student.Sex.MALE,
				"scooby@uni-stuttgart.de"));
	}
}
